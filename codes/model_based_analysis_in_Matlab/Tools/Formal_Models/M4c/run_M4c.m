...
% inF = evolution
options.inF.param_name = {'Sensitivity (value)', 'Inverse decay (value)', 'ExplAlpha', 'ExplBonus'};%, 'pers gain', 'pers loss'};
options.inF.param_transform = {Tsig Tsig Tsig TsigMin10to10};%, Tsig, Tsig};
% inF = evolution (learning)
options.inG.param_name = {'Consistency','Conformity Component','Self-based-conformity'};
options.inG.param_transform = {Tsig0to5,Tsig,Tsig};
