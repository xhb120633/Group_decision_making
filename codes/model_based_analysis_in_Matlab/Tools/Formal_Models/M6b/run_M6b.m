...
% inF = evolution
options.inF.param_name = {'Sensitivity (value)', 'Inverse decay (value)', 'ExplAlpha', 'ExplBonus','Beta(others)'};%, 'pers gain', 'pers loss'};
options.inF.param_transform = {Tsig Tsig Tsig TsigMin10to10,Tsig};%, Tsig, Tsig};
% inF = evolution (learning)
options.inG.param_name = {'Consistency','Discounting'};
