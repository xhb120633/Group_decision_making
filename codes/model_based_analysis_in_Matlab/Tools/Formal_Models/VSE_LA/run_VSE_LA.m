...
% inF = evolution
options.inF.param_name = {'Sensitivity (value)', 'Inverse decay (value)', 'AlphaExpl', 'ExplBonus', 'Loss aversion (value)'};%, 'pers gain', 'pers loss'};
options.inF.param_transform = {Tsig Tsig Tsig TsigMin10to10 Tsig0to5};%, Tsig, Tsig};
