...
% inF = evolution
options.inF.param_name = {'Sensitivity (value)', 'Inverse decay (value)', 'ExplAlpha', 'ExplBonus','Beta(others)','Beta(other)Explor'};%, 'pers gain', 'pers loss'};
