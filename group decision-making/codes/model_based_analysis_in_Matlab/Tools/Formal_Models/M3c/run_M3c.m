...
% inF = evolution
options.inF.param_name = {'Sensitivity (value)', 'Inverse decay (value)', 'ExplAlpha', 'ExplBonus','Beta(others)','Discounting'};%, 'pers gain', 'pers loss'};
